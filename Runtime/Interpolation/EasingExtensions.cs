...
namespace PsigenVision.Utilities.Interpolation
{
    public static class EasingExtensions
    {
        ...
        /// Performance: Lightest. Uses basic multiplication.
        /// </remarks>
        public static float EaseOutQuad(this float t) => 1 - (1 - t) * (1 - t);
        ...
        /// Logic Tip: Use Cubic when Quadratic feels too "linear" or "lazy."
        /// </remarks>
        public static float EaseOutCubic(this float t) => 1 - Mathf.Pow(1 - t, 3);
        ...
        /// Logic Tip: Use Cubic when Quadratic feels too "linear" or "lazy."
        /// </remarks>
        public static float EaseInOutCubic(this float t) => t < 0.5f ? 4 * t * t * t : 1 - Mathf.Pow(-2 * t + 2, 3) / 2;
        ...
        /// </remarks>
        public static float EaseInPow2(this float t) => Mathf.Approximately(t, 0) ? 0 : Mathf.Pow(2, 10 * t - 10);
        ...
        /// Logic Tip: Avoid using this for long durations (e.g., 2+ seconds), as the object will appear to stand still for the first second before teleporting.
        /// </remarks>
        public static float EaseOutPow2(this float t) => Mathf.Approximately(t, 1) ? 1 : 1 - Mathf.Pow(2, -10 * t);
        ...
        /// </remarks>
        public static float EaseInBack(this float t) => t * t * ((s + 1) * t - s);
        ...
        /// Performance: Light/Moderate. A few extra multiplications.
        /// </remarks>
        public static float EaseOutBack(this float t) => 1 + (--t * t * ((s + 1) * t + s));
